<script src="/application/views/layouts/js/register.js"></script> <!-- js validation -->
...
<span class="border">
    <form class="form-css" action="/account/register" method="post">
        ...
        <button class="btn btn-lg btn-primary btn-block" type="submit" name="register" onclick="return reg_valid(this.form);">Sign up</button>
